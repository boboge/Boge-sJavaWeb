...
<div id="login_out" style="width: 100px; display: none;">
	...
	<div onclick="loginout();">退出系统</div>
        ...
        <div region="west" split="true" title="菜单" style="width:200px;" >
         ...
         <div title="我的财产管理" style="overflow:hidden;">
        		   <ul>					
						<li 
							onclick = "addTab('报修财物管理(个人)','user/myUnManageList.jsp')">报修财物管理
						</li>				
                        <li style="cursor: pointer;" 
							onclick = "addTab('已处理报修管理(个人)','user/myOkManageList.jsp')">已处理报修管理
						</li>					
					</ul>					
		 </div>
		 <div title="寝室财产管理" style="overflow:hidden;">
        		   <ul>					
						<li style="cursor: pointer;" 
							onclick = "addTab('报修财物管理(寝室)','user/publicUnManageList.jsp')">报修财物管理
						</li>
					</ul>
					<ul>					
                        <li style="cursor: pointer;" 
							onclick = "addTab('已处理报修管理(寝室)','user/publicOkManageList.jsp')">已处理报修管理
						</li>					
					</ul>							 
         </div>
		 <div title="个人信息管理">
           	<ul>					
				<li style="cursor: pointer;" 
					onclick = "addTab('我的寝室','user/myDormitory.jsp')">我的寝室
				</li>
				<li style="cursor: pointer;" 
